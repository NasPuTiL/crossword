<template>
    <v-container grid-list-lg>
        <v-layout row v-if="['Home'].includes($route.name)">
            <v-flex xs12 class="text-sm-center display-1 font-weight-black my-5"
                >Available Meal Plans</v-flex
            >
        </v-layout>
        <div v-if="['menu'].includes($route.name)" class="mt-10"></div>
        <v-layout row wrap>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <div>
                                The Paleo diet requires the sole or predominant
